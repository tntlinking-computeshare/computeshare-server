...
func (_q *ComputeSpecPriceQuery) Where(ps ...predicate.ComputeSpecPrice) *ComputeSpecPriceQuery {
	_q.predicates = append(_q.predicates, ps...)
	return _q
}

// Limit the number of records to be returned by this query.
func (_q *ComputeSpecPriceQuery) Limit(limit int) *ComputeSpecPriceQuery {
	_q.ctx.Limit = &limit
	return _q
}
...
func (_q *ComputeSpecPriceQuery) Order(o ...computespecprice.OrderOption) *ComputeSpecPriceQuery {
...
func (_q *ComputeSpecPriceQuery) First(ctx context.Context) (*ComputeSpecPrice, error) {
...
func (_q *ComputeSpecPriceQuery) FirstX(ctx context.Context) *ComputeSpecPrice {
...
func (_q *ComputeSpecPriceQuery) Only(ctx context.Context) (*ComputeSpecPrice, error) {
...
func (_q *ComputeSpecPriceQuery) OnlyX(ctx context.Context) *ComputeSpecPrice {
...
func (_q *ComputeSpecPriceQuery) All(ctx context.Context) ([]*ComputeSpecPrice, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryAll)
	if err := _q.prepareQuery(ctx); err != nil {
		return nil, err
	}
	qr := querierAll[[]*ComputeSpecPrice, *ComputeSpecPriceQuery]()
	return withInterceptors[[]*ComputeSpecPrice](ctx, _q, qr, _q.inters)
}

// AllX is like All, but panics if an error occurs.
func (_q *ComputeSpecPriceQuery) AllX(ctx context.Context) []*ComputeSpecPrice {
...
func (_q *ComputeSpecPriceQuery) IDs(ctx context.Context) (ids []int32, err error) {
	...
	if err = _q.Select(computespecprice.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *ComputeSpecPriceQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, _q, querierCount[*ComputeSpecPriceQuery](), _q.inters)
}
...
func (_q *ComputeSpecPriceQuery) Clone() *ComputeSpecPriceQuery {
	if _q == nil {
		return nil
	}
	return &ComputeSpecPriceQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]computespecprice.OrderOption{}, _q.order...),
		inters:     append([]Interceptor{}, _q.inters...),
		predicates: append([]predicate.ComputeSpecPrice{}, _q.predicates...),
...
func (_q *ComputeSpecPriceQuery) GroupBy(field string, fields ...string) *ComputeSpecPriceGroupBy {
	...
	grbuild := &ComputeSpecPriceGroupBy{build: _q}
...
func (_q *ComputeSpecPriceQuery) Select(fields ...string) *ComputeSpecPriceSelect {
	...
	sbuild := &ComputeSpecPriceSelect{ComputeSpecPriceQuery: _q}
...
func (_q *ComputeSpecPriceQuery) Aggregate(fns ...AggregateFunc) *ComputeSpecPriceSelect {
	return _q.Select().Aggregate(fns...)
}

func (_q *ComputeSpecPriceQuery) prepareQuery(ctx context.Context) error {
...
func (_q *ComputeSpecPriceQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*ComputeSpecPrice, error) {
	var (
	...
	_spec.Assign = func(columns []string, values []any) error {
		node := &ComputeSpecPrice{config: _q.config}
...
func (_q *ComputeSpecPriceQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := _q.querySpec()
...
func (_q *ComputeSpecPriceQuery) querySpec() *sqlgraph.QuerySpec {
...
func (_q *ComputeSpecPriceQuery) sqlQuery(ctx context.Context) *sql.Selector {
...
func (_g *ComputeSpecPriceGroupBy) Aggregate(fns ...AggregateFunc) *ComputeSpecPriceGroupBy {
...
func (_g *ComputeSpecPriceGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*ComputeSpecPriceQuery, *ComputeSpecPriceGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *ComputeSpecPriceGroupBy) sqlScan(ctx context.Context, root *ComputeSpecPriceQuery, v any) error {
...
func (_s *ComputeSpecPriceSelect) Aggregate(fns ...AggregateFunc) *ComputeSpecPriceSelect {
...
func (_s *ComputeSpecPriceSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*ComputeSpecPriceQuery, *ComputeSpecPriceSelect](ctx, _s.ComputeSpecPriceQuery, _s, _s.inters, v)
}

func (_s *ComputeSpecPriceSelect) sqlScan(ctx context.Context, root *ComputeSpecPriceQuery, v any) error {
