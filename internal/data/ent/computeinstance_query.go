...
func (_q *ComputeInstanceQuery) Where(ps ...predicate.ComputeInstance) *ComputeInstanceQuery {
...
func (_q *ComputeInstanceQuery) Order(o ...computeinstance.OrderOption) *ComputeInstanceQuery {
...
func (_q *ComputeInstanceQuery) First(ctx context.Context) (*ComputeInstance, error) {
...
func (_q *ComputeInstanceQuery) FirstX(ctx context.Context) *ComputeInstance {
...
func (_q *ComputeInstanceQuery) Only(ctx context.Context) (*ComputeInstance, error) {
...
func (_q *ComputeInstanceQuery) OnlyX(ctx context.Context) *ComputeInstance {
...
func (_q *ComputeInstanceQuery) All(ctx context.Context) ([]*ComputeInstance, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryAll)
	if err := _q.prepareQuery(ctx); err != nil {
		return nil, err
	}
	qr := querierAll[[]*ComputeInstance, *ComputeInstanceQuery]()
	return withInterceptors[[]*ComputeInstance](ctx, _q, qr, _q.inters)
}

// AllX is like All, but panics if an error occurs.
func (_q *ComputeInstanceQuery) AllX(ctx context.Context) []*ComputeInstance {
...
func (_q *ComputeInstanceQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
	...
	if err = _q.Select(computeinstance.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *ComputeInstanceQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, _q, querierCount[*ComputeInstanceQuery](), _q.inters)
}
...
func (_q *ComputeInstanceQuery) Clone() *ComputeInstanceQuery {
	if _q == nil {
		return nil
	}
	return &ComputeInstanceQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]computeinstance.OrderOption{}, _q.order...),
		inters:     append([]Interceptor{}, _q.inters...),
		predicates: append([]predicate.ComputeInstance{}, _q.predicates...),
...
func (_q *ComputeInstanceQuery) GroupBy(field string, fields ...string) *ComputeInstanceGroupBy {
	...
	grbuild := &ComputeInstanceGroupBy{build: _q}
...
func (_q *ComputeInstanceQuery) Select(fields ...string) *ComputeInstanceSelect {
	...
	sbuild := &ComputeInstanceSelect{ComputeInstanceQuery: _q}
...
func (_q *ComputeInstanceQuery) Aggregate(fns ...AggregateFunc) *ComputeInstanceSelect {
	return _q.Select().Aggregate(fns...)
}

func (_q *ComputeInstanceQuery) prepareQuery(ctx context.Context) error {
...
func (_q *ComputeInstanceQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*ComputeInstance, error) {
	var (
	...
	_spec.Assign = func(columns []string, values []any) error {
		node := &ComputeInstance{config: _q.config}
...
func (_q *ComputeInstanceQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := _q.querySpec()
...
func (_q *ComputeInstanceQuery) querySpec() *sqlgraph.QuerySpec {
...
func (_q *ComputeInstanceQuery) sqlQuery(ctx context.Context) *sql.Selector {
...
func (_g *ComputeInstanceGroupBy) Aggregate(fns ...AggregateFunc) *ComputeInstanceGroupBy {
...
func (_g *ComputeInstanceGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*ComputeInstanceQuery, *ComputeInstanceGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *ComputeInstanceGroupBy) sqlScan(ctx context.Context, root *ComputeInstanceQuery, v any) error {
...
func (_s *ComputeInstanceSelect) Aggregate(fns ...AggregateFunc) *ComputeInstanceSelect {
...
func (_s *ComputeInstanceSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*ComputeInstanceQuery, *ComputeInstanceSelect](ctx, _s.ComputeInstanceQuery, _s, _s.inters, v)
}

func (_s *ComputeInstanceSelect) sqlScan(ctx context.Context, root *ComputeInstanceQuery, v any) error {
