...
func (sq *ScriptQuery) QueryScriptExecutionRecords() *ScriptExecutionRecordQuery {
	query := (&ScriptExecutionRecordClient{config: sq.config}).Query()
...
func (sq *ScriptQuery) Clone() *ScriptQuery {
	...
	return &ScriptQuery{
		...
		withScriptExecutionRecords: sq.withScriptExecutionRecords.Clone(),
...
func (sq *ScriptQuery) WithScriptExecutionRecords(opts ...func(*ScriptExecutionRecordQuery)) *ScriptQuery {
	...
	sq.withScriptExecutionRecords = query
	return sq
}
...
func (sq *ScriptQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Script, error) {
	var (
		...
		_spec       = sq.querySpec()
		loadedTypes = [1]bool{
			sq.withScriptExecutionRecords != nil,
		}
	)
	...
	if query := sq.withScriptExecutionRecords; query != nil {
		if err := sq.loadScriptExecutionRecords(ctx, query, nodes,
...
func (sq *ScriptQuery) loadScriptExecutionRecords(ctx context.Context, query *ScriptExecutionRecordQuery, nodes []*Script, init func(*Script), assign func(*Script, *ScriptExecutionRecord)) error {
