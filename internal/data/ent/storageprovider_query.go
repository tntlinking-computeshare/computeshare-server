...
func (spq *StorageProviderQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (spq *StorageProviderQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (spq *StorageProviderQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (spq *StorageProviderQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (spq *StorageProviderQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (spq *StorageProviderQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := spq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (spq *StorageProviderQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(storageprovider.Table, storageprovider.Columns, sqlgraph.NewFieldSpec(storageprovider.FieldID, field.TypeUUID))
	_spec.From = spq.sql
