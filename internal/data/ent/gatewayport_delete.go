...
func (_d *GatewayPortDelete) Where(ps ...predicate.GatewayPort) *GatewayPortDelete {
...
func (_d *GatewayPortDelete) sqlExec(ctx context.Context) (int, error) {
...
type GatewayPortDeleteOne struct {
	_d *GatewayPortDelete
}

// Where appends a list predicates to the GatewayPortDelete builder.
func (_d *GatewayPortDeleteOne) Where(ps ...predicate.GatewayPort) *GatewayPortDeleteOne {
