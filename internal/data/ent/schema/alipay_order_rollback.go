...
func (AlipayOrderRollback) Fields() []ent.Field {
	return []ent.Field{
		...
		field.String("sign").Comment("签名"),
		field.String("fund_bill_list").Comment("支付成功的各个渠道金额信息。详情可查看 资金明细信息说明"),
		...
		field.String("voucher_detail_list").Comment("本交易支付时所有优惠券信息，详情可查看 优惠券信息说明"),
		field.String("passback_params").Comment("公共回传参数，如果请求时传递了该参数，则返回给商家时会在异步通知时将该参数原样返回。本参数必须进行 UrlEncode 之后才可以发送给支付宝。"),
