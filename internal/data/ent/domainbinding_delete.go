...
func (_d *DomainBindingDelete) Where(ps ...predicate.DomainBinding) *DomainBindingDelete {
...
func (_d *DomainBindingDelete) sqlExec(ctx context.Context) (int, error) {
...
type DomainBindingDeleteOne struct {
	_d *DomainBindingDelete
}

// Where appends a list predicates to the DomainBindingDelete builder.
func (_d *DomainBindingDeleteOne) Where(ps ...predicate.DomainBinding) *DomainBindingDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *DomainBindingDeleteOne) Exec(ctx context.Context) error {
