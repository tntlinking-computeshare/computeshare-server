...
import (
	...
	computeV1 "github.com/tntlinking-computeshare/computeshare-server/api/server/compute/v1"
	dashboardV1 "github.com/tntlinking-computeshare/computeshare-server/api/server/dashboard/v1"
	networkmappingV1 "github.com/tntlinking-computeshare/computeshare-server/api/server/network_mapping/v1"
	orderv1 "github.com/tntlinking-computeshare/computeshare-server/api/server/order/v1"
	queueTaskV1 "github.com/tntlinking-computeshare/computeshare-server/api/server/queue/v1"
	systemv1 "github.com/tntlinking-computeshare/computeshare-server/api/server/system/v1"
...
func NewWhiteListMatcher() selector.MatchFunc {
	...
	whiteList["/server.compute.v1.ComputeInstance/ListComputeImage"] = struct{}{}
	//dashboard
...
func NewHTTPServer(c *conf.Server,
	...
	computeV1.RegisterSandboxHTTPServer(srv, processService)
