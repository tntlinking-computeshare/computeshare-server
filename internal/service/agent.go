...
import (
	...
	pb "github.com/tntlinking-computeshare/computeshare-server/api/server/agent/v1"

	computepb "github.com/tntlinking-computeshare/computeshare-server/api/server/compute/v1"
)
