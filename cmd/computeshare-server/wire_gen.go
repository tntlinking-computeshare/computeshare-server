...
func wireApp(confServer *conf.Server, confData *conf.Data, confDispose *conf.Dispose, auth *conf.Auth, logger log.Logger) (*kratos.App, func(), error) {
	...
	storageS3UseCase := biz.NewStorageS3UseCase(s3UserRepo, userRepo, confDispose, logger)
