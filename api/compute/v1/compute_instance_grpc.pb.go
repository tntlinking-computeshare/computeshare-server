...
const (
	...
	ComputeInstance_RestartInstance_FullMethodName             = "/api.compute.v1.ComputeInstance/RestartInstance"
	ComputeInstance_GetInstanceVncURL_FullMethodName           = "/api.compute.v1.ComputeInstance/GetInstanceVncURL"
)
