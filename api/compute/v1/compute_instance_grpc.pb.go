...
const (
	...
	ComputeInstance_GetComputeImage_FullMethodName      = "/api.server.compute.v1.ComputeInstance/GetComputeImage"
...
func (c *computeInstanceClient) GetComputeImage(ctx context.Context, in *GetComputeImageRequest, opts ...grpc.CallOption) (*GetComputeImageReply, error) {
	...
	err := c.cc.Invoke(ctx, ComputeInstance_GetComputeImage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
