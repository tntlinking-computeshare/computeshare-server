...
const (
	Dashboard_ProvidersCount_FullMethodName              = "/server.dashboard.v1.Dashboard/ProvidersCount"
	Dashboard_GatewaysCount_FullMethodName               = "/server.dashboard.v1.Dashboard/GatewaysCount"
	Dashboard_StoragesCount_FullMethodName               = "/server.dashboard.v1.Dashboard/StoragesCount"
	Dashboard_StoragesProvidersList_FullMethodName       = "/server.dashboard.v1.Dashboard/StoragesProvidersList"
	Dashboard_StorageBucketsVolumeNumList_FullMethodName = "/server.dashboard.v1.Dashboard/StorageBucketsVolumeNumList"
	Dashboard_StorageS3KeyCallCount_FullMethodName       = "/server.dashboard.v1.Dashboard/StorageS3KeyCallCount"
	Dashboard_ProvidersList_FullMethodName               = "/server.dashboard.v1.Dashboard/ProvidersList"
	Dashboard_GatewaysList_FullMethodName                = "/server.dashboard.v1.Dashboard/GatewaysList"
	Dashboard_CyclesCount_FullMethodName                 = "/server.dashboard.v1.Dashboard/CyclesCount"
	Dashboard_SandboxCount_FullMethodName                = "/server.dashboard.v1.Dashboard/SandboxCount"
	Dashboard_LastComputeInstancesCount_FullMethodName   = "/server.dashboard.v1.Dashboard/LastComputeInstancesCount"
)
...
func (c *dashboardClient) ProvidersCount(ctx context.Context, in *ProvidersCountRequest, opts ...grpc.CallOption) (*ProvidersCountReply, error) {
	...
	err := c.cc.Invoke(ctx, Dashboard_ProvidersCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dashboardClient) GatewaysCount(ctx context.Context, in *GatewaysCountRequest, opts ...grpc.CallOption) (*GatewaysCountReply, error) {
	...
	err := c.cc.Invoke(ctx, Dashboard_GatewaysCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dashboardClient) StoragesCount(ctx context.Context, in *StoragesCountRequest, opts ...grpc.CallOption) (*StoragesCountReply, error) {
	...
	err := c.cc.Invoke(ctx, Dashboard_StoragesCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dashboardClient) StoragesProvidersList(ctx context.Context, in *StoragesProvidersListRequest, opts ...grpc.CallOption) (*StoragesProvidersListReply, error) {
	...
	err := c.cc.Invoke(ctx, Dashboard_StoragesProvidersList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dashboardClient) StorageBucketsVolumeNumList(ctx context.Context, in *StorageBucketsVolumeNumListRequest, opts ...grpc.CallOption) (*StorageBucketsVolumeNumListReply, error) {
	...
	err := c.cc.Invoke(ctx, Dashboard_StorageBucketsVolumeNumList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dashboardClient) StorageS3KeyCallCount(ctx context.Context, in *StorageS3KeyCallCountRequest, opts ...grpc.CallOption) (*StorageS3KeyCallCountReply, error) {
	...
	err := c.cc.Invoke(ctx, Dashboard_StorageS3KeyCallCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dashboardClient) ProvidersList(ctx context.Context, in *ProvidersListRequest, opts ...grpc.CallOption) (*ProvidersListReply, error) {
	...
	err := c.cc.Invoke(ctx, Dashboard_ProvidersList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dashboardClient) GatewaysList(ctx context.Context, in *GatewaysListRequest, opts ...grpc.CallOption) (*GatewaysListReply, error) {
	...
	err := c.cc.Invoke(ctx, Dashboard_GatewaysList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dashboardClient) CyclesCount(ctx context.Context, in *CyclesCountRequest, opts ...grpc.CallOption) (*CyclesCountReply, error) {
	...
	err := c.cc.Invoke(ctx, Dashboard_CyclesCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dashboardClient) SandboxCount(ctx context.Context, in *SandboxCountRequest, opts ...grpc.CallOption) (*SandboxCountReply, error) {
	...
	err := c.cc.Invoke(ctx, Dashboard_SandboxCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dashboardClient) LastComputeInstancesCount(ctx context.Context, in *LastComputeInstancesCountRequest, opts ...grpc.CallOption) (*LastComputeInstancesCountReply, error) {
	...
	err := c.cc.Invoke(ctx, Dashboard_LastComputeInstancesCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Dashboard_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "server.dashboard.v1.Dashboard",
	...
	Metadata: "server/dashboard/v1/dashboard.proto",
}
