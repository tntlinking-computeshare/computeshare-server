...
const OperationComputeInstanceCreate = "/server.compute.v1.ComputeInstance/Create"
const OperationComputeInstanceDelete = "/server.compute.v1.ComputeInstance/Delete"
const OperationComputeInstanceGet = "/server.compute.v1.ComputeInstance/Get"
const OperationComputeInstanceGetComputeImage = "/server.compute.v1.ComputeInstance/GetComputeImage"
const OperationComputeInstanceGetInstanceVncURL = "/server.compute.v1.ComputeInstance/GetInstanceVncURL"
const OperationComputeInstanceList = "/server.compute.v1.ComputeInstance/List"
const OperationComputeInstanceListComputeImage = "/server.compute.v1.ComputeInstance/ListComputeImage"
const OperationComputeInstanceListComputeSpec = "/server.compute.v1.ComputeInstance/ListComputeSpec"
const OperationComputeInstanceListComputeSpecPrice = "/server.compute.v1.ComputeInstance/ListComputeSpecPrice"
const OperationComputeInstanceReCreateInstance = "/server.compute.v1.ComputeInstance/ReCreateInstance"
const OperationComputeInstanceRenameInstance = "/server.compute.v1.ComputeInstance/RenameInstance"
const OperationComputeInstanceRestartInstance = "/server.compute.v1.ComputeInstance/RestartInstance"
const OperationComputeInstanceStartInstance = "/server.compute.v1.ComputeInstance/StartInstance"
const OperationComputeInstanceStopInstance = "/server.compute.v1.ComputeInstance/StopInstance"
...
func RegisterComputeInstanceHTTPServer(s *http.Server, srv ComputeInstanceHTTPServer) {
	...
	r.GET("/v1/compute/image/{id}", _ComputeInstance_GetComputeImage0_HTTP_Handler(srv))
	...
	r.DELETE("/v1/instance/{id}", _ComputeInstance_Delete1_HTTP_Handler(srv))
	r.GET("/v1/instance/{id}", _ComputeInstance_Get0_HTTP_Handler(srv))
	r.GET("/v1/instance", _ComputeInstance_List1_HTTP_Handler(srv))
...
func _ComputeInstance_GetComputeImage0_HTTP_Handler(srv ComputeInstanceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in GetComputeImageRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		...
		http.SetOperation(ctx, OperationComputeInstanceGetComputeImage)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetComputeImage(ctx, req.(*GetComputeImageRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*GetComputeImageReply)
		return ctx.Result(200, reply)
	}
}
...
func _ComputeInstance_Delete1_HTTP_Handler(srv ComputeInstanceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _ComputeInstance_List1_HTTP_Handler(srv ComputeInstanceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
type ComputeInstanceHTTPClient interface {
	...
	// GetComputeImage 查询镜像
	GetComputeImage(ctx context.Context, req *GetComputeImageRequest, opts ...http.CallOption) (rsp *GetComputeImageReply, err error)
	// GetInstanceVncURL 获取vnc 地址
...
// GetComputeImage 查询镜像
func (c *ComputeInstanceHTTPClientImpl) GetComputeImage(ctx context.Context, in *GetComputeImageRequest, opts ...http.CallOption) (*GetComputeImageReply, error) {
	var out GetComputeImageReply
	pattern := "/v1/compute/image/{id}"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationComputeInstanceGetComputeImage))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
