...
const (
	StorageProvider_CreateStorageProvider_FullMethodName = "/server.compute.v1.StorageProvider/CreateStorageProvider"
	StorageProvider_DeleteStorageProvider_FullMethodName = "/server.compute.v1.StorageProvider/DeleteStorageProvider"
	StorageProvider_GetStorageProvider_FullMethodName    = "/server.compute.v1.StorageProvider/GetStorageProvider"
	StorageProvider_ListStorageProvider_FullMethodName   = "/server.compute.v1.StorageProvider/ListStorageProvider"
)
...
func (c *storageProviderClient) CreateStorageProvider(ctx context.Context, in *CreateStorageProviderRequest, opts ...grpc.CallOption) (*CreateStorageProviderReply, error) {
	...
	err := c.cc.Invoke(ctx, StorageProvider_CreateStorageProvider_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageProviderClient) DeleteStorageProvider(ctx context.Context, in *DeleteStorageProviderRequest, opts ...grpc.CallOption) (*DeleteStorageProviderReply, error) {
	...
	err := c.cc.Invoke(ctx, StorageProvider_DeleteStorageProvider_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageProviderClient) GetStorageProvider(ctx context.Context, in *GetStorageProviderRequest, opts ...grpc.CallOption) (*GetStorageProviderReply, error) {
	...
	err := c.cc.Invoke(ctx, StorageProvider_GetStorageProvider_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageProviderClient) ListStorageProvider(ctx context.Context, in *ListStorageProviderRequest, opts ...grpc.CallOption) (*ListStorageProviderReply, error) {
	...
	err := c.cc.Invoke(ctx, StorageProvider_ListStorageProvider_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedStorageProviderServer must be embedded to have
...
func (UnimplementedStorageProviderServer) testEmbeddedByValue()                         {}
...
func RegisterStorageProviderServer(s grpc.ServiceRegistrar, srv StorageProviderServer) {
	// If the following call pancis, it indicates UnimplementedStorageProviderServer was
...
var StorageProvider_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "server.compute.v1.StorageProvider",
	...
	Metadata: "server/compute/v1/storage_provider.proto",
}
