...
const (
	Storage_List_FullMethodName       = "/server.compute.v1.Storage/List"
	Storage_UploadFile_FullMethodName = "/server.compute.v1.Storage/UploadFile"
	Storage_CreateDir_FullMethodName  = "/server.compute.v1.Storage/CreateDir"
	Storage_Download_FullMethodName   = "/server.compute.v1.Storage/Download"
	Storage_Delete_FullMethodName     = "/server.compute.v1.Storage/Delete"
)
...
func (c *storageClient) CreateDir(ctx context.Context, in *CreateDirRequest, opts ...grpc.CallOption) (*CreateDirReply, error) {
	...
	err := c.cc.Invoke(ctx, Storage_CreateDir_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageClient) Download(ctx context.Context, in *DownloadRequest, opts ...grpc.CallOption) (*DownloadReply, error) {
	...
	err := c.cc.Invoke(ctx, Storage_Download_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Storage_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "server.compute.v1.Storage",
	...
	Metadata: "server/compute/v1/storage.proto",
}
