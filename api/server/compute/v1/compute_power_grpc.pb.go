...
const (
	ComputePower_UploadScriptFile_FullMethodName             = "/server.compute.v1.ComputePower/UploadScriptFile"
	ComputePower_GetScriptExecutionRecordList_FullMethodName = "/server.compute.v1.ComputePower/GetScriptExecutionRecordList"
	ComputePower_RunPythonPackage_FullMethodName             = "/server.compute.v1.ComputePower/RunPythonPackage"
	ComputePower_CancelExecPythonPackage_FullMethodName      = "/server.compute.v1.ComputePower/CancelExecPythonPackage"
	ComputePower_GetScriptExecutionRecordInfo_FullMethodName = "/server.compute.v1.ComputePower/GetScriptExecutionRecordInfo"
	ComputePower_DownloadScriptExecuteResult_FullMethodName  = "/server.compute.v1.ComputePower/DownloadScriptExecuteResult"
)
...
func (c *computePowerClient) UploadScriptFile(ctx context.Context, in *UploadScriptFileRequest, opts ...grpc.CallOption) (*UploadScriptFileReply, error) {
	...
	err := c.cc.Invoke(ctx, ComputePower_UploadScriptFile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *computePowerClient) GetScriptExecutionRecordList(ctx context.Context, in *GetScriptExecutionRecordListRequest, opts ...grpc.CallOption) (*GetScriptListReply, error) {
	...
	err := c.cc.Invoke(ctx, ComputePower_GetScriptExecutionRecordList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *computePowerClient) RunPythonPackage(ctx context.Context, in *RunPythonPackageServerRequest, opts ...grpc.CallOption) (*RunPythonPackageServerReply, error) {
	...
	err := c.cc.Invoke(ctx, ComputePower_RunPythonPackage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *computePowerClient) CancelExecPythonPackage(ctx context.Context, in *CancelExecPythonPackageRequest, opts ...grpc.CallOption) (*CancelExecPythonPackageReply, error) {
	...
	err := c.cc.Invoke(ctx, ComputePower_CancelExecPythonPackage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *computePowerClient) GetScriptExecutionRecordInfo(ctx context.Context, in *GetScriptExecutionRecordInfoRequest, opts ...grpc.CallOption) (*GetScriptInfoReply, error) {
	...
	err := c.cc.Invoke(ctx, ComputePower_GetScriptExecutionRecordInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *computePowerClient) DownloadScriptExecuteResult(ctx context.Context, in *DownloadScriptExecuteResultRequest, opts ...grpc.CallOption) (*DownloadScriptExecuteResultReply, error) {
	...
	err := c.cc.Invoke(ctx, ComputePower_DownloadScriptExecuteResult_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedComputePowerServer must be embedded to have
...
func (UnimplementedComputePowerServer) testEmbeddedByValue()                      {}
...
func RegisterComputePowerServer(s grpc.ServiceRegistrar, srv ComputePowerServer) {
	// If the following call pancis, it indicates UnimplementedComputePowerServer was
...
var ComputePower_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "server.compute.v1.ComputePower",
	...
	Metadata: "server/compute/v1/compute_power.proto",
}
