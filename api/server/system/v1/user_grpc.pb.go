...
const (
	User_CreateUser_FullMethodName            = "/server.system.v1.User/CreateUser"
	User_UpdateUser_FullMethodName            = "/server.system.v1.User/UpdateUser"
	User_UpdateUserPassword_FullMethodName    = "/server.system.v1.User/UpdateUserPassword"
	User_UpdateUserTelephone_FullMethodName   = "/server.system.v1.User/UpdateUserTelephone"
	User_GetUser_FullMethodName               = "/server.system.v1.User/GetUser"
	User_ListUser_FullMethodName              = "/server.system.v1.User/ListUser"
	User_Login_FullMethodName                 = "/server.system.v1.User/Login"
	User_LoginWithClient_FullMethodName       = "/server.system.v1.User/LoginWithClient"
	User_LoginWithValidateCode_FullMethodName = "/server.system.v1.User/LoginWithValidateCode"
	User_SendValidateCode_FullMethodName      = "/server.system.v1.User/SendValidateCode"
	User_VerifyCode_FullMethodName            = "/server.system.v1.User/VerifyCode"
)
...
func (c *userClient) UpdateUserTelephone(ctx context.Context, in *UpdateUserTelephoneRequest, opts ...grpc.CallOption) (*UpdateUserTelephoneReply, error) {
	...
	err := c.cc.Invoke(ctx, User_UpdateUserTelephone_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) LoginWithClient(ctx context.Context, in *LoginWithClientRequest, opts ...grpc.CallOption) (*LoginReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LoginReply)
	err := c.cc.Invoke(ctx, User_LoginWithClient_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) LoginWithValidateCode(ctx context.Context, in *LoginWithValidateCodeRequest, opts ...grpc.CallOption) (*LoginReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LoginReply)
	err := c.cc.Invoke(ctx, User_LoginWithValidateCode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) SendValidateCode(ctx context.Context, in *SendValidateCodeRequest, opts ...grpc.CallOption) (*SendValidateCodeReply, error) {
	...
	err := c.cc.Invoke(ctx, User_SendValidateCode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var User_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "server.system.v1.User",
	...
	Metadata: "server/system/v1/user.proto",
}
