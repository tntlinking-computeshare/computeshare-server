...
const file_server_order_v1_order_proto_rawDesc = "" +
	...
	"\x0fRenewDailyCheck\x12\".server.order.v1.DailyCheckRequest\x1a .server.order.v1.DailyCheckReply\"(\x82\xd3\xe4\x93\x02\":\x01*\"\x1d/v1/cycle/renewal/daily-checkB_\n" +
	"\fapi.order.v1P\x01ZMgithub.com/tntlinking-computeshare/computeshare-server/api/server/order/v1;v1b\x06proto3"
