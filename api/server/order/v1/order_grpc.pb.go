...
func (c *orderClient) AlipayPayNotify(ctx context.Context, in *AlipayPayNotifyRequest, opts ...grpc.CallOption) (*AlipayPayNotifyReply, error) {
	...
	err := c.cc.Invoke(ctx, Order_AlipayPayNotify_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderClient) RechargeCycleByAlipay(ctx context.Context, in *RechargeCycleByAlipayRequest, opts ...grpc.CallOption) (*RechargeCycleByAlipayReply, error) {
	...
	err := c.cc.Invoke(ctx, Order_RechargeCycleByAlipay_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderClient) GetRechargeState(ctx context.Context, in *GetRechargeStateRequest, opts ...grpc.CallOption) (*GetRechargeStateReply, error) {
	...
	err := c.cc.Invoke(ctx, Order_GetRechargeState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderClient) RechargeCycleByRedeemCode(ctx context.Context, in *RechargeCycleByRedeemCodeRequest, opts ...grpc.CallOption) (*RechargeCycleByRedeemCodeReply, error) {
	...
	err := c.cc.Invoke(ctx, Order_RechargeCycleByRedeemCode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderClient) GetCycleBalance(ctx context.Context, in *GetCycleBalanceRequest, opts ...grpc.CallOption) (*GetCycleBalanceReply, error) {
	...
	err := c.cc.Invoke(ctx, Order_GetCycleBalance_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderClient) CycleTransactionList(ctx context.Context, in *CycleTransactionListRequest, opts ...grpc.CallOption) (*CycleTransactionListReply, error) {
	...
	err := c.cc.Invoke(ctx, Order_CycleTransactionList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderClient) CreateCycleRenewal(ctx context.Context, in *CycleRenewalCreateRequest, opts ...grpc.CallOption) (*CycleRenewalCreateReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CycleRenewalCreateReply)
	err := c.cc.Invoke(ctx, Order_CreateCycleRenewal_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderClient) CycleRenewalDetail(ctx context.Context, in *CycleRenewalGetRequest, opts ...grpc.CallOption) (*CycleRenewalGetReply, error) {
	...
	err := c.cc.Invoke(ctx, Order_CycleRenewalDetail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderClient) DeleteCycleRenewal(ctx context.Context, in *CycleRenewalGetRequest, opts ...grpc.CallOption) (*CycleRenewalBaseReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CycleRenewalBaseReply)
	err := c.cc.Invoke(ctx, Order_DeleteCycleRenewal_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderClient) CycleRenewalList(ctx context.Context, in *CycleRenewalListRequest, opts ...grpc.CallOption) (*CycleRenewalListReply, error) {
	...
	err := c.cc.Invoke(ctx, Order_CycleRenewalList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderClient) CycleRenewalOpen(ctx context.Context, in *CycleRenewalGetRequest, opts ...grpc.CallOption) (*CycleRenewalBaseReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CycleRenewalBaseReply)
	err := c.cc.Invoke(ctx, Order_CycleRenewalOpen_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderClient) CycleRenewalClose(ctx context.Context, in *CycleRenewalGetRequest, opts ...grpc.CallOption) (*CycleRenewalBaseReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CycleRenewalBaseReply)
	err := c.cc.Invoke(ctx, Order_CycleRenewalClose_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderClient) ManualRenew(ctx context.Context, in *ManualRenewRequest, opts ...grpc.CallOption) (*ManualRenewReply, error) {
	...
	err := c.cc.Invoke(ctx, Order_ManualRenew_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderClient) RenewDailyCheck(ctx context.Context, in *DailyCheckRequest, opts ...grpc.CallOption) (*DailyCheckReply, error) {
	...
	err := c.cc.Invoke(ctx, Order_RenewDailyCheck_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServer interface {
	...
	CreateCycleRenewal(context.Context, *CycleRenewalCreateRequest) (*CycleRenewalCreateReply, error)
	CycleRenewalDetail(context.Context, *CycleRenewalGetRequest) (*CycleRenewalGetReply, error)
	DeleteCycleRenewal(context.Context, *CycleRenewalGetRequest) (*CycleRenewalBaseReply, error)
...
func (UnimplementedOrderServer) CreateCycleRenewal(context.Context, *CycleRenewalCreateRequest) (*CycleRenewalCreateReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateCycleRenewal not implemented")
}
...
func (UnimplementedOrderServer) DeleteCycleRenewal(context.Context, *CycleRenewalGetRequest) (*CycleRenewalBaseReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteCycleRenewal not implemented")
}
...
func _Order_CreateCycleRenewal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CycleRenewalCreateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).CreateCycleRenewal(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Order_CreateCycleRenewal_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).CreateCycleRenewal(ctx, req.(*CycleRenewalCreateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Order_DeleteCycleRenewal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CycleRenewalGetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).DeleteCycleRenewal(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Order_DeleteCycleRenewal_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).DeleteCycleRenewal(ctx, req.(*CycleRenewalGetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
