...
const OperationAgentCreateAgent = "/server.agent.v1.Agent/CreateAgent"
const OperationAgentDeleteAgent = "/server.agent.v1.Agent/DeleteAgent"
const OperationAgentGetAgent = "/server.agent.v1.Agent/GetAgent"
const OperationAgentListAgent = "/server.agent.v1.Agent/ListAgent"
const OperationAgentListAgentInstance = "/server.agent.v1.Agent/ListAgentInstance"
const OperationAgentReportInstanceStatus = "/server.agent.v1.Agent/ReportInstanceStatus"
const OperationAgentUpdateAgent = "/server.agent.v1.Agent/UpdateAgent"
