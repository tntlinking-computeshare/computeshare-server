...
const (
	Agent_CreateAgent_FullMethodName          = "/server.agent.v1.Agent/CreateAgent"
	Agent_UpdateAgent_FullMethodName          = "/server.agent.v1.Agent/UpdateAgent"
	Agent_DeleteAgent_FullMethodName          = "/server.agent.v1.Agent/DeleteAgent"
	Agent_GetAgent_FullMethodName             = "/server.agent.v1.Agent/GetAgent"
	Agent_ListAgent_FullMethodName            = "/server.agent.v1.Agent/ListAgent"
	Agent_ListAgentInstance_FullMethodName    = "/server.agent.v1.Agent/ListAgentInstance"
	Agent_ReportInstanceStatus_FullMethodName = "/server.agent.v1.Agent/ReportInstanceStatus"
)
...
func (c *agentClient) ListAgentInstance(ctx context.Context, in *ListAgentInstanceReq, opts ...grpc.CallOption) (*v1.ListInstanceReply, error) {
	...
	err := c.cc.Invoke(ctx, Agent_ListAgentInstance_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentClient) ReportInstanceStatus(ctx context.Context, in *v1.Instance, opts ...grpc.CallOption) (*ReportInstanceStatusReply, error) {
	...
	err := c.cc.Invoke(ctx, Agent_ReportInstanceStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Agent_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "server.agent.v1.Agent",
	...
	Metadata: "server/agent/v1/agent.proto",
}
