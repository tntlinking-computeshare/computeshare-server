...
const file_server_network_mapping_v1_network_mapping_proto_rawDesc = "" +
	...
	"\x14UpdateNetworkMapping\x126.server.network_mapping.v1.UpdateNetworkMappingRequest\x1a4.server.network_mapping.v1.UpdateNetworkMappingReply\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\x1a\x19/v1/network-mappings/{id}Bs\n" +
	"\x16api.network_mapping.v1P\x01ZWgithub.com/tntlinking-computeshare/computeshare-server/api/server/network_mapping/v1;v1b\x06proto3"
