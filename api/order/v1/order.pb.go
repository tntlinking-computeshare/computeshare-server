...
var file_api_order_v1_order_proto_rawDesc = []byte{
	...
	0x32, 0xdf, 0x05, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x8b, 0x01, 0x0a, 0x0f, 0x41,
	...
	0x6f, 0x6e, 0x42, 0x4b, 0x0a, 0x0c, 0x61, 0x70, 0x69, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e,
...
var file_api_order_v1_order_proto_goTypes = []interface{}{
	...
	(*RechargeCycleByAlipayReply_Pay)(nil),   // 14: api.server.order.v1.RechargeCycleByAlipayReply.Pay
}
var file_api_order_v1_order_proto_depIdxs = []int32{
	14, // 0: api.server.order.v1.RechargeCycleByAlipayReply.data:type_name -> api.server.order.v1.RechargeCycleByAlipayReply.Pay
	...
	0,  // 5: api.server.order.v1.Order.AlipayPayNotify:input_type -> api.server.order.v1.AlipayPayNotifyRequest
	2,  // 6: api.server.order.v1.Order.RechargeCycleByAlipay:input_type -> api.server.order.v1.RechargeCycleByAlipayRequest
	4,  // 7: api.server.order.v1.Order.RechargeCycleByRedeemCode:input_type -> api.server.order.v1.RechargeCycleByRedeemCodeRequest
	6,  // 8: api.server.order.v1.Order.OrderList:input_type -> api.server.order.v1.OrderListRequest
	10, // 9: api.server.order.v1.Order.CycleTransactionList:input_type -> api.server.order.v1.CycleTransactionListRequest
	1,  // 10: api.server.order.v1.Order.AlipayPayNotify:output_type -> api.server.order.v1.AlipayPayNotifyReply
	3,  // 11: api.server.order.v1.Order.RechargeCycleByAlipay:output_type -> api.server.order.v1.RechargeCycleByAlipayReply
	5,  // 12: api.server.order.v1.Order.RechargeCycleByRedeemCode:output_type -> api.server.order.v1.RechargeCycleByRedeemCodeReply
	7,  // 13: api.server.order.v1.Order.OrderList:output_type -> api.server.order.v1.OrderListReply
	11, // 14: api.server.order.v1.Order.CycleTransactionList:output_type -> api.server.order.v1.CycleTransactionListReply
