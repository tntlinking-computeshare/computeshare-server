...
var file_api_order_v1_order_proto_rawDesc = []byte{
	...
	0x6e, 0x54, 0x69, 0x6d, 0x65, 0x32, 0x9b, 0x03, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12,
	...
	0x61, 0x79, 0x2f, 0x70, 0x61, 0x79, 0x2f, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x6a, 0x0a,
	...
	0x69, 0x6f, 0x6e, 0x42, 0x4b, 0x0a, 0x0c, 0x61, 0x70, 0x69, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72,
...
var file_api_order_v1_order_proto_depIdxs = []int32{
	...
	2, // 5: api.server.order.v1.Order.OrderList:input_type -> api.server.order.v1.OrderListRequest
	6, // 6: api.server.order.v1.Order.CycleTransactionList:input_type -> api.server.order.v1.CycleTransactionListRequest
	1, // 7: api.server.order.v1.Order.AlipayPayNotify:output_type -> api.server.order.v1.AlipayPayNotifyReply
	3, // 8: api.server.order.v1.Order.OrderList:output_type -> api.server.order.v1.OrderListReply
	7, // 9: api.server.order.v1.Order.CycleTransactionList:output_type -> api.server.order.v1.CycleTransactionListReply
